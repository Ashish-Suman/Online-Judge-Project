...
let PATH_INIT = path.join(
  "/mnt/4AC0ABFEC0ABEDFF/Web Dev/Online-Judge-Project/server",
  "/submissions/"
);
...
const test = function (problem, submission, callback) {
...
module.exports.addSubmission = (problem, submission, callback) => {
    console.log(callback)
  test(problem, submission, callback)
};
